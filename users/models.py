...
class UserProfile(models.Model):
    ...
    shipping_postal_code = models.CharField(max_length=20, blank=True, verbose_name='Postal Code')
    shipping_country = models.CharField(max_length=100, blank=True, verbose_name='Country')

    # Preferences
    receive_email_notifications = models.BooleanField(default=True, verbose_name='Email Notifications')
    receive_sms_notifications = models.BooleanField(default=False, verbose_name='SMS Notifications')
